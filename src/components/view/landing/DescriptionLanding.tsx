          ...
          <div className='md:basis-7/12 lg:w-1/2'>
            ...
            <div className='space-y-4 divide-y divide-gray-100 dark:divide-gray-800'>
              <div className='mt-8 flex gap-4 md:items-center'>
                ...
                <div className='w-5/6'>
                  <h4 className='text-lg font-semibold text-gray-700 dark:text-indigo-300'>Take notes</h4>
                  <p className='text-gray-500 dark:text-gray-400'>You can create and edit notes with a system of recommendations.</p>
                </div> 
              </div> 
              <div className='flex gap-4 pt-4 md:items-center'>
                ...
                <div className='w-5/6'>
                  <h4 className='text-lg font-semibold text-gray-700 dark:text-teal-300'>Share your notes</h4>
                  <p className='text-gray-500 dark:text-gray-400'>You have all the notes of your group.</p>
                </div> 
              </div> 
            </div>
          </div>
