...
const NotesView: React.FC = () => {
  ...
  const notesHeaderDown = (
    <div className='flex border h-30 border-rounded rounded-full bg-gray-800 justify-center text-center text-white'>
      <div
        className="flex-auto group relative w-40 justify-center py-2 px-4 text-xl font-medium"
      >
        <span className="absolute inset-y-0 left-0 flex items-center pl-3">
