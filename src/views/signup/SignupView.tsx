      ...
      <div className='relative mx-auto my-[10%] max-h-full w-full max-w-2xl'>
        <div className='relative rounded-lg bg-white shadow'>
          <div className='flex items-start justify-between rounded-t border-b p-4'>
            ...
            <button type='button' className='ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900' onClick={props.hide}>
      ...
      >
        <Stack direction='column' spacing={2}>
          ...
          <div className='relative my-5 mx-10'>
            ...
            <span className='absolute right-auto top-0 -left-2 -translate-y-1/2 -translate-x-1/2 -rotate-12 rounded-full bg-red-400 p-0.5 px-2 text-center text-xs font-medium leading-none text-white outline outline-red-100'>
              BETA
            </span>
          </div>
          <FormControlLabel
